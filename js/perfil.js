document.addEventListener("DOMContentLoaded", () => {
  ...
  const btnInicioPerfil = document.getElementById('btnInicioPerfil');
  const brandInicioPerfil = document.getElementById('brandInicioPerfil');
  const inicioUrl = currentUser.role === 'candidato'
    ? 'candidato-dashboard.html'
    : 'index.html';

  if (btnInicioPerfil) {
    btnInicioPerfil.href = inicioUrl;
  }

  if (brandInicioPerfil) {
    brandInicioPerfil.href = inicioUrl;
  }
